    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=product.models.category.categor_image_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage', models.DecimalField(decimal_places=2, max_digits=7, null=True)),
                ('ram', models.DecimalField(decimal_places=2, max_digits=7, null=True)),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product.product')),
            ],
            options={
                'abstract': False,
